<template>
    <a :href="guildDiscordForeverLink" class="discord-button" target="_blank" rel="noopener noreferrer">
...
export default {
    ...
    data() {
        return {
            guildDiscordForeverLink: "https://discord.gg/BgFGsWH"
        }
    }
